      ...
      <div className="relative w-full h-[100vh] z-[0] overflow-hidden">
        <img
          ...
          className="
            ...
            [filter:brightness(1.05)_contrast(0.93)]
            scale-[1.03]
          "
          alt="YORISOI Hero"
        />
...
<div
  className="
    ...
    bg-[linear-gradient(
      to_bottom,
      rgba(255,255,255,0.08) 0%,     /* 12% → 8% */
      rgba(255,255,255,0.06) 35%,    /* 10% → 6% */
      rgba(255,255,255,0.035) 65%,   /* 6% → 3.5% */
      rgba(255,255,255,0.02) 85%,    /* 3% → 2% */
      rgba(255,255,255,0) 100%
    )]
    mix-blend-screen
  "
...
<div
  className="
    ...
    bg-[linear-gradient(
      to_bottom,
      rgba(255,255,255,0.48) 0%,      /* 72% → 48% （眩しさ対策） */
      rgba(255,255,255,0.28) 16%,     /* 50% → 28% */
      rgba(255,255,255,0.20) 34%,     /* 34% → 20% */
      rgba(255,255,255,0.12) 56%,     /* 20% → 12% */
      rgba(255,255,255,0.06) 78%,     /* 10% → 6% */
      rgba(255,255,255,0) 100%
    )]

    /* 気づかれないレベルのぼかし（世界観維持） */
    backdrop-blur-[0.68px]     /* 0.85px → 0.68px に優しく */
